...
public class SalesOrderF extends AppCompatActivity implements View.OnClickListener {
    private EditText editTextN,editTextS,editTextW,editTextPhone,editTextP; //用户名，数量，微信，手机号，品种
    private Button buttonfabu; //发布按钮
    private ImageView returnImage; //返回按钮
    private TextView te_result,sales_orderallf;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sales_order_farmer); //绑定布局
        init(); //初始化控件
    }
    ...
    private void init() {
        ...
        buttonfabu = (Button) findViewById(R.id.gs_salesorder_f);
        sales_orderallf = (TextView) findViewById(R.id.gs_sales_orderallf);
        ...
        sales_orderallf.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.gs_salesorder_f:
                salesorderf(); //发布方法
                break;
            case R.id.gs_sales_orderallf:
                Intent intent = new Intent(this,Sales_orderAllf.class); //跳转页面
    ...
    private void salesorderf() {
        ...
        new Thread(new Runnable() {
            ...
            private void requestGet(HashMap<String, String> paramsMap) {
                try {
                    String baseUrl = "http://10.0.2.2:8080/GVegetableServer/servlet/SalesOrderFServlet?";
