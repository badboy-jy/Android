...
public class Sales_c extends AppCompatActivity implements View.OnClickListener {
    private TextView sales_f,salesorder_f,salesorder_c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sales_c);
        ...
        SimpleAdapter adapter = new SimpleAdapter(
                ...
                list1,
                R.layout.itemsalesc,
                new String[]{"logo","name","shuliang","price","phone"},
                new int []{R.id.logo,R.id.gs_name,R.id.gs_shuliang,R.id.gs_price,R.id.gs_phone}

        );
        lv.setAdapter(adapter);
        sales_f  = (TextView) findViewById(R.id.gs_sales_f);
        back = (ImageView) findViewById(R.id.gs_return);
        salesorder_c = (TextView) findViewById(R.id.gs_salesorder_c);
        salesorder_f = (TextView) findViewById(R.id.gs_salesorder_f);
        spinner=(Spinner)findViewById(R.id.spinnerc);
        sales_f.setOnClickListener(this);
        back.setOnClickListener(this);
        salesorder_c.setOnClickListener(this);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    // 新建一个URL对象
                    String baseUrl = "http://10.0.2.2:8080/GVegetableServer/servlet/SalesAllCServlet?pinzhong=ganlan";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.gs_sales_f:
                Intent intent1 = new Intent(this,Sales_f.class);
                startActivity(intent1);
                break;
            case R.id.gs_salesorder_c:
                Intent intent2 = new Intent(this,SalesOrderC.class);
                startActivity(intent2);
                break;
            case R.id.gs_salesorder_f:
                Intent intent3 = new Intent(this,Sales_orderAllf.class);
