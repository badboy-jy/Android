...
public class Plantshengzhang extends AppCompatActivity implements View.OnClickListener {
    private TextView plantexperience,to_result;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shengzhangjilu);
        plantexperience  = (TextView) findViewById(R.id.gs_experice);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    // 新建一个URL对象
                    String baseUrl = "http://10.0.2.2:8080/GVegetableServer/servlet/SZJiLuAllServlet";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.gs_experice:  //登录按钮
                Intent intent = new Intent(this,Plantexprience.class);
    ...
    private void newsfasong() {
        ...
        new Thread(new Runnable() {
            ...
            private void requestGet(HashMap<String, String> paramsMap) {
                try {
                    String baseUrl = "http://10.0.2.2:8080/GVegetableServer/servlet/SZJiLuOutServlet?";
