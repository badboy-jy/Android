...
public class Rent extends AppCompatActivity implements View.OnClickListener {
    private EditText editTextN,editTextS,editTextPrice,editTextW,editTextPhone,editTextY; //用户名，数量，价格，微信，手机号，年数
    private Button buttonrent; //发布按钮
    private ImageView returnImage; //返回按钮
    private TextView te_result,rent_all;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rent); //绑定布局
        init(); //初始化控件
    }
    ...
    private void init() {
        ...
        editTextY = (EditText) findViewById(R.id.gs_year);
        buttonrent = (Button) findViewById(R.id.gs_rent);
        rent_all = (TextView) findViewById(R.id.gs_rent_all);
        te_result = (TextView) findViewById(R.id.gs_result);
        returnImage = (ImageView) findViewById(R.id.gs_return);
        buttonrent.setOnClickListener(this); //点击事件
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.gs_rent_all:
                Intent intent = new Intent(this,Rent_all.class); //跳转页面
                startActivity(intent);
                break;
            case R.id.gs_return:
                Intent intent1 = new Intent(this,Land.class); //跳转页面
    ...
    private void rent() {
        ...
        String year = editTextY.getText().toString().trim();//获取年数
        ...
        stringHashMap.put("year", editTextY.getText().toString());
        if (TextUtils.isEmpty(name)){
            ...
            Toast.makeText(this, "年数不能为空", Toast.LENGTH_SHORT).show();
            editTextPrice.requestFocus();
            return;
        }
        ...
        new Thread(new Runnable() {
            ...
            private void requestGet(HashMap<String, String> paramsMap) {
                try {
                    String baseUrl = "http://10.0.2.2:8080/GVegetableServer/servlet/RentServlet?";
