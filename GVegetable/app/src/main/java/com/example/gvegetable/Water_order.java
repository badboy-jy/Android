...
public class Water_order extends AppCompatActivity implements View.OnClickListener {
    private EditText editTextN,editTextT,editTextW,editTextPhone; //用户名，时间，价格，微信，手机号
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.water_order); //绑定布局
        init(); //初始化控件
    }
    ...
    private void waterorder() {
        ...
        String time = editTextT.getText().toString().trim(); //获取功能
        ...
        new Thread(new Runnable() {
            ...
            private void requestGet(HashMap<String, String> paramsMap) {
                try {
                    String baseUrl = "http://10.0.2.2:8080/GVegetableServer/servlet/Water_orderServlet?";
