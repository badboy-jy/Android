...
public class Rent_all extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rent_all);
        ...
        SimpleAdapter adapter = new SimpleAdapter(
                ...
                list1,
                R.layout.itemrent,
                new String[]{"logo","name","shuliang","price","phone","year"},
                new int []{R.id.logo,R.id.gs_name,R.id.gs_shuliang,R.id.gs_price,R.id.gs_phone,R.id.gs_year}

        );
        lv.setAdapter(adapter);
        rent  = (TextView) findViewById(R.id.gs_rent);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    // 新建一个URL对象
                    String baseUrl = "http://10.0.2.2:8080/GVegetableServer/servlet/Rent_allServlet";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.gs_return:  //登录按钮
                ...
                break;
            case R.id.gs_rent:
                Intent intent1 = new Intent(this,Rent.class);
