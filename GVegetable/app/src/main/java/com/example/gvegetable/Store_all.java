...
public class Store_all extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.store_all);
        ...
        SimpleAdapter adapter = new SimpleAdapter(
                ...
                list1,
                R.layout.itemstore,
                new String[]{"logo","name","gongju","price","phone"},
                new int []{R.id.logo,R.id.gs_name,R.id.gs_gongju,R.id.gs_price,R.id.gs_phone}

        );
        lv.setAdapter(adapter);
        store_sell  = (TextView) findViewById(R.id.gs_store_sell);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    // 新建一个URL对象
                    String baseUrl = "http://10.0.2.2:8080/GVegetableServer/servlet/Store_allServlet";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.gs_store_sell:
                Intent intent1 = new Intent(this,Store_sell.class);
