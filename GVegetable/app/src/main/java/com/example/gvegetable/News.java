...
public class News extends AppCompatActivity implements View.OnClickListener {
    private TextView main,to_result;
    private ImageView back;
    private EditText editTextN,editNews;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextN=(EditText) findViewById(R.id.gs_name);
        editNews=(EditText) findViewById(R.id.gs_news);
        fasong = (Button) findViewById(R.id.gs_newsout);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    // 新建一个URL对象
                    String baseUrl = "http://10.0.2.2:8080/GVegetableServer/servlet/NewsAllServlet";
    ...
    private void newsfasong() {
        ...
        String news= editNews.getText().toString().trim();//获取
        stringHashMap.put("name",editTextN.getText().toString());
        stringHashMap.put("news", editNews.getText().toString());
        ...
        new Thread(new Runnable() {
            ...
            private void requestGet(HashMap<String, String> paramsMap) {
                try {
                    String baseUrl = "http://10.0.2.2:8080/GVegetableServer/servlet/NewsOutServlet?";
