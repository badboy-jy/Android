...
public class War1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleAdapter adapter = new SimpleAdapter(
                ...
                list1,
                R.layout.itemwar1,
                new String[]{"logo","name","time","phone"},
                new int []{R.id.logo,R.id.gs_name,R.id.gs_time,R.id.gs_phone}

        );
        lv.setAdapter(adapter);
        water  = (TextView) findViewById(R.id.gs_water);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.gs_return:  //登录按钮
                ...
                break;
            case R.id.gs_warter:
                Intent intent1 = new Intent(this,Water.class);
